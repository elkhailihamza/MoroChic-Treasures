    ...
    <section className="bg-[FEFAE0] flex flex-col justify-center align-center">
      ...
      <div className="flex justify-center gap-5 flex-wrap">
        ...
        <div className="lg:w-2/5 w-4/5 mt-5">
          <div className="flex flex-col justify-between xl:ms-20 ms-6 w-full">
            ...
            <div className="flex flex-col items-center lg:text-center gap-5 h-full xl:mt-5 md:mt-1 mt-5 mb-10">
